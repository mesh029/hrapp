...
import { adjustWorkflowSchema, uuidSchema } from '@/lib/utils/validation';
import { adjustWorkflowStep } from '@/lib/services/workflow';

/**
 * POST /api/workflows/instances/[id]/adjust
...
export async function POST(
  ...
  try {
    ...
    const validation = adjustWorkflowSchema.safeParse(body);
    ...
    await adjustWorkflowStep({
      ...
      routeToStep: validation.data.route_to_step,
      ipAddress,
      userAgent,
    });
    ...
    console.error('Adjust workflow step error:', error);
