...
import { declineWorkflowSchema, uuidSchema } from '@/lib/utils/validation';
import { declineWorkflowStep } from '@/lib/services/workflow';

/**
 * POST /api/workflows/instances/[id]/decline
...
export async function POST(
  ...
  try {
    ...
    const validation = declineWorkflowSchema.safeParse(body);
    ...
    console.error('Decline workflow step error:', error);
